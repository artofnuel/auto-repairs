...
const services = [
  {
    ...
    description:
      "Complete engine diagnostics, repair and rebuild services to keep your vehicle running at peak performance.",
  ...
  },
  {
    ...
    description:
      "Expert restoration services for classic and vintage vehicles, bringing them back to their original glory or creating custom masterpieces.",
  ...
  },
  {
    ...
    description:
      "Enhance your vehicle's performance with our professional upgrade services, from turbocharging to suspension improvements.",
  ...
  },
  {
    ...
    description:
      "Complete interior and exterior detailing services using premium products for a showroom-quality finish.",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          {services.map((service) => (
            <motion.div
              key={service.id}
              className="p-5 border-2 border-primary-500/30 rounded-md flex flex-col h-full"
